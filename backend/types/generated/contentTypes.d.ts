...
export interface ApiPostPost extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Art\u00EDculos del blog, editables por el equipo de marketing sin ayuda de desarrollo.';
...
export interface ApiProyectoProyecto extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Casos de proyectos por industria, editables por el equipo de marketing sin ayuda de desarrollo.';
  ...
  attributes: {
    ...
    imagen: Schema.Attribute.Media<'images'>;
    industria: Schema.Attribute.String & Schema.Attribute.Required;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
...
export interface ApiTestimonioTestimonio extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Testimonios de clientes, editables por el equipo de marketing sin ayuda de desarrollo.';
